...
import svgPaths from "../imports/Desktop1-1/svg-m28o3weh1g";
import imgImage66 from "../imports/Desktop1-1/b2a665648dcdbaa537f982baed705f51f9563175.png";
import imgChatGptImageApr232026051856Pm11 from "../imports/Desktop1-1/a80fa66d44b0ff61c570b989d6fb551d46380225.png";
import imgChatGptImageApr232026051856Pm12 from "../imports/Desktop1-1/2ed5559bf52ac38f0d906307f0ed5c48d52a224a.png";
import imgChatGptImageApr232026051856Pm13 from "../imports/Desktop1-1/5358f3e3b9a49f0d5d69994ddaa8f725c44612c4.png";
import imgChatGptImageApr232026060921Pm11 from "../imports/Desktop1-1/8f19d030d8313642b002781d5770cb6f6c459878.png";
import imgChatGptImageApr232026060922Pm21 from "../imports/Desktop1-1/04f8e3b346a8c0e06398d32733333cbb68af1a6b.png";
import imgChatGptImageApr232026060922Pm31 from "../imports/Desktop1-1/57024bd76b5740e6a880a2acf386a78aa2b10fa8.png";
  ...
  return (
    <div className="flex flex-col items-center bg-white px-6 py-16">
      ...
      <div className="mb-12 w-full max-w-md relative">
        <svg className="h-auto w-full" fill="none" viewBox="0 0 819.892 256">
          <g clipPath="url(#clip0_1_239)">
            ...
            <path d={svgPaths.p123a9f60} stroke="url(#paint0_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p21624440} stroke="url(#paint1_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.pe4db960} stroke="url(#paint2_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p510e600} stroke="url(#paint3_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p2e229900} stroke="url(#paint4_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.pc115780} stroke="url(#paint5_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p3bf3d180} stroke="url(#paint6_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p3f53d2c0} stroke="url(#paint7_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p21bd2000} stroke="url(#paint8_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d={svgPaths.p313dfde0} stroke="url(#paint9_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
            <path d="M711.769 127.996H778.918" stroke="url(#paint10_linear_1_239)" strokeMiterlimit="10" strokeWidth="2.18269" />
          ...
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_239" x1="332.379" x2="332.379" y1="6.73522" y2="114.525">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_1_239" x1="285.386" x2="285.386" y1="87.5685" y2="127.99">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_1_239" x1="365.955" x2="365.955" y1="101.06" y2="141.481">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint3_linear_1_239" x1="312.242" x2="312.242" y1="114.505" y2="154.927">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint4_linear_1_239" x1="292.094" x2="292.094" y1="127.996" y2="168.418">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint5_linear_1_239" x1="329.025" x2="329.025" y1="141.487" y2="181.909">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint6_linear_1_239" x1="245.101" x2="245.101" y1="154.933" y2="249.249">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint7_linear_1_239" x1="345.818" x2="345.818" y1="168.424" y2="208.845">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint8_linear_1_239" x1="587.554" x2="587.554" y1="114.505" y2="154.927">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint9_linear_1_239" x1="594.269" x2="594.269" y1="127.996" y2="168.418">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint10_linear_1_239" x1="745.344" x2="745.344" y1="127.996" y2="128.996">
              <stop offset="0.509615" stopColor="#231F20" />
              <stop offset="0.735577" stopColor="#00FF88" />
            </linearGradient>
        ...
        {/* Badges positioned using Figma coordinates */}
        <div className="absolute bg-[#3a5e3c] flex items-center justify-center" style={{ inset: '0 82.6% 87.53% 13.5%' }}>
          <p className="font-['Office_Code_Pro:Medium',sans-serif] text-[10px] leading-[1.2] tracking-[1.2px] uppercase text-white whitespace-nowrap">
            01
          </p>
        </div>

        <div className="absolute bg-[#3a5e3c] flex items-center justify-center" style={{ inset: '5.72% 40.62% 81.81% 55.49%' }}>
          <p className="font-['Office_Code_Pro:Medium',sans-serif] text-[10px] leading-[1.2] tracking-[1.2px] uppercase text-white whitespace-nowrap">
            02
          </p>
        </div>

        <div className="absolute bg-[#3a5e3c] flex items-center justify-center" style={{ inset: '16.63% 0 70.89% 96.11%' }}>
          <p className="font-['Office_Code_Pro:Medium',sans-serif] text-[10px] leading-[1.2] tracking-[1.2px] uppercase text-white whitespace-nowrap">
            03
          </p>
        </div>
      ...
      <div className="mx-auto flex max-w-md flex-col gap-6 px-6">
        <div className="space-y-2">
          ...
          <p className="font-['ABC_Gramercy:Regular',sans-serif] text-[14px] leading-[1.2] text-[#3a5e3c]">
            Data remains encrypted and never exposed to any single party
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="font-['ABC_Gramercy:Regular',sans-serif] text-[14px] leading-[1.2] text-[#3a5e3c]">
            Results can be independently verified without revealing inputs
          </p>
        </div>
      </div>
    </div>
...
function WhatBecomesPossibleSection() {
      ...
      <div className="flex w-full max-w-md flex-col gap-3">
        ...
        >
          <div className="flex items-center justify-center gap-1">
            ...
            <motion.span
              className="font-['Office_Code_Pro:Medium',sans-serif] text-[14px] tracking-[1.4px] uppercase text-[#3a5e3c] transition-colors group-hover:text-[#82f5ad]"
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: hoveredButton === 'participate' ? 1 : 0, x: hoveredButton === 'participate' ? 0 : -10 }}
              transition={{ duration: 0.25, ease: [0.4, 0, 0.2, 1] }}
            >
...
function ExploreCard({ image, title, description, cta }: { image: string; title: string; description: string; cta: string }) {
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-6 flex flex-col gap-2">
          ...
          <div className="font-['ABC_Gramercy:Regular',sans-serif] flex flex-col text-[22px] leading-[1.05] capitalize text-[#3a5e3c]">
            <button
              className="text-left transition-colors hover:text-[#82f5ad]"
