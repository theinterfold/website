...
import { PageTag } from "../../app/components/PageTag";
...
function Frame() {
  ...
  return (
    <div className="relative isolate bg-[#d9fce8] md:absolute w-full md:left-1/2 md:-translate-x-1/2 md:top-[calc(555px+min(44.444vw,640px))]">
      <motion.div
...
function Frame19() {
  return (
    <div className="md:-translate-x-1/2 md:absolute relative bg-[#d9fce8] content-stretch flex flex-col gap-[64px] md:gap-[96px] items-center justify-center md:left-1/2 py-[64px] md:py-[112px] md:top-[calc(1741px+min(44.444vw,640px))] w-full">
      <Frame16 />
      <Frame23 />
    </div>
  );
...
function Frame11() {
  return (
    <div id="participate" className="md:absolute md:-translate-x-1/2 relative bg-[#121718] content-stretch flex flex-col items-center justify-center md:left-1/2 py-[64px] md:py-[112px] md:top-[calc(2725px+min(44.444vw,640px))] w-full">
      <Frame10 />
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="md:-translate-x-1/2 md:absolute relative bg-white content-stretch flex flex-col gap-[64px] md:gap-[96px] items-center md:left-1/2 pb-[64px] md:pb-[224px] pt-[64px] md:pt-[112px] md:top-[calc(3224px+min(44.444vw,640px))] w-full">
      <Frame18 />
      <Frame30 />
    </div>
  );
...
function Frame15() {
  ...
  return (
    <div
      id="execution-model"
      className="md:-translate-x-1/2 md:absolute relative bg-white content-stretch flex flex-col gap-[64px] md:gap-[96px] md:h-[1071px] items-center md:left-1/2 py-[64px] md:py-[112px] md:top-[calc(670px+min(44.444vw,640px))] w-full"
    >
      <Frame14 />
...
function Frame13() {
  return (
    <div className="md:-translate-x-1/2 md:absolute relative bg-[#d9fce8] content-stretch flex flex-col gap-[48px] items-center md:left-1/2 py-[64px] md:py-[112px] lg:h-[555px] md:top-[min(44.444vw,640px)] w-full">
      <Frame12 />
      <Frame17 />
    </div>
  );
...
export function DesktopFooter({ staticLayout = false }: { staticLayout?: boolean }) {
  return (
    <footer className={`${staticLayout ? "relative" : "md:absolute relative md:left-0 md:top-[calc(4049px+min(44.444vw,640px))]"} bg-[#d9fce8] w-full`}>
